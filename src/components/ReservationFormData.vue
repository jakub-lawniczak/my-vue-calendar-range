        ...
        <form @submit.prevent="checkForm" novalidate="true">
            <div class="form-data">
                <div class="form-data__row">
                    ...
                    <input type="text" class="form-data__input" id="first-name" :class="{ 'form-data__input--error' : error.firstName}" v-model="userData.firstName">
                    <p class="form-data__error">{{error.firstName}}</p>
                </div>
                <div class="form-data__row">
                    <label class="form-data__label" for="last-name">Last Name</label>
                    <input type="text" class="form-data__input" id="last-name" :class="{ 'form-data__input--error' : error.lastName}" v-model="userData.lastName">
                    <p class="form-data__error">{{error.lastName}}</p>
                </div>
                <div class="form-data__row">
                    <label class="form-data__label" for="email">Mail</label>
                    <input type="text" class="form-data__input" id="email" :class="{ 'form-data__input--error' : error.email}" v-model="userData.email">
